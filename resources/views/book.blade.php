        ...
        <div class="row section">
            ...
            <div class="col s12 m6">
                    <ul class="collection with-header component">
                        ...
                        <li class="collection-item"><strong>Number of pages:</strong>&nbsp;{{ $book->pages ?? "Not Specified"}}</li>
                        <li class="collection-item"><strong>Year of Publication:</strong>&nbsp;{{ $book->year ?? "Not Specified"}}</li>
                        <li class="collection-item"><strong>Language:</strong>&nbsp;{{ $book->language ?? "Not Specified"}}</li>
                    </ul>
            </div>
